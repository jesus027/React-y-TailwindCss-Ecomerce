...
const initialState = {
    cartState: false,
    cartItems: localStorage.getItem("cart") ? JSON.parse(localStorage.getItem("cart")) : [], //Supongamos la Base de Datos
    cartTotalAmount: 0,
    cartTotalQantity: 0,
};
    ...
    reducers: {
        ...
        setAddItemToCart: (state, action) => {
            ...
            if (itemIndex >= 0) {
                ...
                toast.success('cantidad de artículo aumentada');
            }else {
        ...
        setIncreaseItemQTY: (state, action) => {
            ...
            if (itemIndex >= 0) {
                ...
                toast.success('Cantidad del Artículo Aumentada');
            }
            localStorage.setItem("cart", JSON.stringify(state.cartItems));
        },
        ...
        setDecreaseItemQTY: (state, action) => {
            ...
            if (state.cartItems[itemIndex].cartQuantity > 1) {
                ...
                toast.success('Cantidad del Artículo Disminuida');
            }
            localStorage.setItem("cart", JSON.stringify(state.cartItems));
        },
