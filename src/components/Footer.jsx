            ...
            <footer className='bg-theme pt-7 pb-5'>
                <div className='store-container text-slate-200'>
                    ...
                    <div className='mt-5 text-center'>
                        <p className='text-sm md:text-center'>Copyright<sup className='text-base font-bold'>&copy;</sup> Todos los Derechos Reservados 2023 <span>Jesús E. Piñero A. Developer</span></p>
                    </div>
                </div>
            </footer>
        </>
